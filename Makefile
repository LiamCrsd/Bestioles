main : main.cpp Aquarium.o Bestiole.o Ecosystem.o BestioleFactory.o
	g++ -Wall -std=c++11 -o main main.cpp Aquarium.o Bestiole.o Ecosystem.o BestioleFactory.o -I . -lX11 -lpthread
