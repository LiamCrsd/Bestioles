main : main.cpp Aquarium.o Bestiole.o Ecosystem.o ExternalActionner.o BestioleFactory.o CollectionBestiole.o Accessory.o Fins.o Shell.o Camouflage.o Sensor.o Ears.o Eyes.o
	g++ -Wall -std=c++11 -o main main.cpp Aquarium.o Bestiole.o Ecosystem.o ExternalActionner.o BestioleFactory.o CollectionBestiole.o Accessory.o Fins.o Shell.o Camouflage.o Sensor.o Ears.o Eyes.o -I . -lX11 -lpthread
